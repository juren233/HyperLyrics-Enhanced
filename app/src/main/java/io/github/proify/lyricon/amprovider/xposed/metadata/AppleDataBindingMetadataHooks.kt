...
internal class AppleDataBindingMetadataHooks(
    ...
    internal val host: AppleDataBindingMetadataHost,
) {
    ...
    internal val visibleResolutionPosts =
        Collections.synchronizedMap(
            WeakHashMap<Any, PendingVisibleDataBindingResolution>()
        )
    internal val bindingContentFields = ConcurrentHashMap<Class<*>, List<Field>>()

    @Volatile
    internal var bindingBaseClass: Class<*>? = null
    @Volatile
    internal var recyclerViewClass: Class<*>? = null
    @Volatile
