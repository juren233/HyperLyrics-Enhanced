...
fun LazyListScope.translationSections(
    ...
    onAppleMusicMatchOnlineTranslationChange: (Boolean) -> Unit,
    appleMusicTranslationQqFirst: Boolean,
    onAppleMusicTranslationQqFirstChange: (Boolean) -> Unit,
        ...
        Column {
            ...
            Card(modifier = Modifier.padding(horizontal = 12.dp).padding(bottom = 12.dp).fillMaxWidth()) {
                Column {
                    ...
                    SwitchPreference(
                        title = stringResource(id = R.string.title_adjacent_background_translation),
                        summary = stringResource(id = R.string.summary_adjacent_background_translation),
                        checked = adjacentBackgroundTranslation,
                        onCheckedChange = onAdjacentBackgroundTranslationChange,
                        enabled = translationControlsEnabled && adjacentBackgroundTranslationAvailable
                    )
                }
            }
                ...
                Card(modifier = Modifier.padding(horizontal = 12.dp).padding(bottom = 12.dp).fillMaxWidth()) {
                    Column {
                        if (lyricSource == "lyricon") {
                            SwitchPreference(
                                title = stringResource(id = R.string.title_apple_music_match_online_translation),
                                summary = stringResource(id = R.string.summary_apple_music_match_online_translation),
                                checked = appleMusicMatchOnlineTranslation,
                                onCheckedChange = onAppleMusicMatchOnlineTranslationChange,
                                enabled = translationControlsEnabled
                            )
                            AnimatedVisibility(visible = appleMusicMatchOnlineTranslation) {
                                SwitchPreference(
                                    title = stringResource(id = R.string.title_apple_music_translation_qq_first),
                                    summary = stringResource(id = R.string.summary_apple_music_translation_qq_first),
                                    checked = appleMusicTranslationQqFirst,
                                    onCheckedChange = onAppleMusicTranslationQqFirstChange,
                                    enabled = translationControlsEnabled
                                )
                            }
                        }
