...
fun LyricTranslationPage() {
    ...
    var appleMusicTranslationQqFirst by remember {
        mutableStateOf(
            prefs.getBoolean(
    ...
    XposedLyricSettingPage(title = stringResource(id = R.string.title_translation)) {
        translationSections(
            ...
            appleMusicMatchOnlineTranslation = appleMusicMatchOnlineTranslation,
            onAppleMusicMatchOnlineTranslationChange = {
                appleMusicMatchOnlineTranslation = it
                saveConfig(RootConstants.KEY_HOOK_APPLE_MUSIC_MATCH_ONLINE_TRANSLATION, it)
            },
            appleMusicTranslationQqFirst = appleMusicTranslationQqFirst,
            onAppleMusicTranslationQqFirstChange = {
                appleMusicTranslationQqFirst = it
                saveConfig(RootConstants.KEY_HOOK_APPLE_MUSIC_TRANSLATION_QQ_FIRST, it)
            },
