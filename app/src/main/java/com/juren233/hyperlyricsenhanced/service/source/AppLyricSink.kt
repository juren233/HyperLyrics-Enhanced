...
import com.juren233.hyperlyricsenhanced.service.NotificationPresenter
import com.juren233.hyperlyricsenhanced.service.scheduler.LyricScheduler
import com.juren233.hyperlyricsenhanced.service.scheduler.LyricSchedulerListener
            ...
            fetchJob = scope.launch(Dispatchers.IO) {
                ...
                if (currentSongIdentifier == data.identifier) {
                    if (!rawLines.isNullOrEmpty()) {
                        ...
                        val noLyricText = context.getString(com.juren233.hyperlyricsenhanced.R.string.no_lyric_data)
